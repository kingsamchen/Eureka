...
option(HASHIDS_USE_MSVC_PARALLEL_BUILD "If enabled, build multiple files in parallel." ON)
option(HASHIDS_USE_MSVC_STATIC_ANALYSIS "If enabled, run MSVC built-in static analysis and generate appropriate warnings" OFF)
option(HASHIDS_USE_WIN32_LEAN_AND_MEAN "If enabled, define WIN32_LEAN_AND_MEAN" ON)
...
message(STATUS "HASHIDS_USE_MSVC_PARALLEL_BUILD = ${HASHIDS_USE_MSVC_PARALLEL_BUILD}")
message(STATUS "HASHIDS_USE_MSVC_STATIC_ANALYSIS = ${HASHIDS_USE_MSVC_STATIC_ANALYSIS}")
message(STATUS "HASHIDS_USE_WIN32_LEAN_AND_MEAN = ${HASHIDS_USE_WIN32_LEAN_AND_MEAN}")
...
function(hashids_apply_common_compile_options TARGET)
  target_compile_definitions(${TARGET}
    PUBLIC
      ...
      $<$<BOOL:HASHIDS_USE_WIN32_LEAN_AND_MEAN>:WIN32_LEAN_AND_MEAN>
  )
...
function(hashids_apply_msvc_parallel_build TARGET)
...
# hashids_apply_msvc_static_analysis(foobar
#   WDL
#     /wd6011
# )
function(hashids_apply_msvc_static_analysis TARGET)
