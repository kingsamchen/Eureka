...
option(SPDLOG_WRAPPER_USE_MSVC_PARALLEL_BUILD "If enabled, build multiple files in parallel." ON)
option(SPDLOG_WRAPPER_USE_WIN32_LEAN_AND_MEAN "If enabled, define WIN32_LEAN_AND_MEAN" ON)

if(SPDLOG_WRAPPER_NOT_SUBPROJECT)
  message(STATUS "spdlog_wrapper compiler MSVC global conf is in active")
...
message(STATUS "SPDLOG_WRAPPER_USE_MSVC_PARALLEL_BUILD = ${SPDLOG_WRAPPER_USE_MSVC_PARALLEL_BUILD}")
message(STATUS "SPDLOG_WRAPPER_USE_WIN32_LEAN_AND_MEAN = ${SPDLOG_WRAPPER_USE_WIN32_LEAN_AND_MEAN}")
  ...
  if(NOT TARGET_TYPE STREQUAL "INTERFACE_LIBRARY")
    target_compile_definitions(${TARGET}
      PUBLIC
        ...
        $<$<BOOL:SPDLOG_WRAPPER_USE_WIN32_LEAN_AND_MEAN>:WIN32_LEAN_AND_MEAN>
    )
    ...
    target_compile_options(${TARGET}
      PRIVATE
        ...
        $<$<BOOL:SPDLOG_WRAPPER_USE_MSVC_PARALLEL_BUILD>:/MP>
    )
  else()
    target_compile_definitions(${TARGET}
      INTERFACE
