...
option(HEY_I_AM_STILL_WORKING_USE_MSVC_PARALLEL_BUILD "If enabled, build multiple files in parallel." ON)
option(HEY_I_AM_STILL_WORKING_USE_MSVC_STATIC_ANALYSIS "If enabled, run MSVC built-in static analysis and generate appropriate warnings" OFF)
...
message(STATUS "HEY_I_AM_STILL_WORKING_USE_MSVC_PARALLEL_BUILD = ${HEY_I_AM_STILL_WORKING_USE_MSVC_PARALLEL_BUILD}")
message(STATUS "HEY_I_AM_STILL_WORKING_USE_MSVC_STATIC_ANALYSIS = ${HEY_I_AM_STILL_WORKING_USE_MSVC_STATIC_ANALYSIS}")
message(STATUS "HEY_I_AM_STILL_WORKING_USE_WIN32_LEAN_AND_MEAN = ${HEY_I_AM_STILL_WORKING_USE_WIN32_LEAN_AND_MEAN}")

function(hey_i_am_still_working_apply_common_compile_options TARGET)
  target_compile_definitions(${TARGET}
    PUBLIC
      ...
      $<$<BOOL:HEY_I_AM_STILL_WORKING_USE_WIN32_LEAN_AND_MEAN>:WIN32_LEAN_AND_MEAN>
  )
...
# hey_i_am_still_working_apply_msvc_static_analysis(foobar
#   WDL
#     /wd6011
# )
